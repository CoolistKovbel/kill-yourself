    ...
    <footer className="bg-[#111] text-white   pt-6 p-y-[20px] flex items-center justify-between flex-col md:flex-row">
      ...
      <div className="flex flex-col gap-[14px] p-4 w-full">
        ...
        <p className="font-semibold">
          Trying to make life easier slow and steady.. Please support our future: <span className="text-[12px]">0x1C352E8F3e035c524F2385818b44859906d3c705</span>
        </p>
      ...
      <div className="flex justify-end gap-[100px] p-4 text-right">
